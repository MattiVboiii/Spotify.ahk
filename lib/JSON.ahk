...
class JSON {
	...
	; Compatibility aliases used by Spotify.ahk (objects, not Maps; compact output)
	static Load(text) => JSON.parse(text, false, false)
	static Dump(value) => JSON.stringify(value, 0, "")
